...
- `docs/agent-skills/` is the report and inventory layer. Runtime skills live under `.agents/skills/`, which is the stronger existing repo convention referenced by `AGENTS.md`.
